...
func NewMsgCreateResource(creator string, name string, value string) *MsgCreateResource {
...
func NewMsgUpdateResource(creator string, id uint64, name string, value string) *MsgUpdateResource {
